...
export default {
  ...
  methods: {
    ...
    update(status){
      ...
      this.$axios.patch(`/layouts/${this.$route.params.slug}`, this.form).then(res => {
        this.snackbar = true;
        this.$router.push(`/dashboard/layouts/edit/${res.data.data.slug}`);
  ...
  mounted() {
       this.$axios.get(`/layouts/${this.$route.params.slug}`).then(res => {
        const layout = res.data.data;

        if (layout.image != null) {
          this.imageId = layout.image.id;
          this.imageUrl = layout.image.size.medium;
          this.imageFile = layout.image.size.medium;
          this.imageName = layout.image.title;
          this.form.image = layout.image.id;
        }
        this.form.id = layout.id;
        this.form.title = layout.title;
        this.form.description = layout.description;
